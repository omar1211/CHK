...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('هنا يمك المطور عمر ابشر  @T_3_A')
...
async def join_channel():
    try:
        await sython(JoinChannelRequest("@L_H_V"))
    except BaseException:
        pass
...
async def _(event):
      await event.reply("""السـورس يعمـل |القرش
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
